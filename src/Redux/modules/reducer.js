...
export default function reducer(state = initialState, action) {
  switch (action.type) {
    ...
    case types.AUTORIZE_USER:
      let userId;
      for (const key in state.usersById) {
    ...
    case types.CHANGE_USER_NAME:
      const changedUserName = Object.assign(
        {}, state.usersById[state.activeUser],
        {
          name: action.name,
        }
      );
      const newUsersByIdName = Object.assign(
        {}, state.usersById,
        {
    ...
    case types.CHANGE_USER_SECOND_NAME:
      const changedUserSecondName = Object.assign(
        {}, state.usersById[state.activeUser],
        {
          secondName: action.secondName,
        }
      );
      const newUsersByIdSecondName = Object.assign(
        {}, state.usersById,
        {
    ...
    case types.CHANGE_USER_EMAIL:
      const changedUserEmail = Object.assign(
        {}, state.usersById[state.activeUser],
        {
          Email: action.email,
        }
      );
      const newUsersByIdEmail = Object.assign(
        {}, state.usersById,
        {
    ...
    case types.CHANGE_USER_LOGIN:
      const changedUserLogin = Object.assign(
        {}, state.usersById[state.activeUser],
        {
          login: action.login,
        }
      );
      const newUsersByIdLogin = Object.assign(
        {}, state.usersById,
        {
    ...
    case types.CHANGE_USER_PASSWORD:
      const changedUserPassword = Object.assign(
        {}, state.usersById[state.activeUser],
        {
          password: action.password,
        }
      );
      const newUsersByIdPassword = Object.assign(
        {}, state.usersById,
        {
